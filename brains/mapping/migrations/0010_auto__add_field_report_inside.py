...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.inside'
        db.add_column('mapping_report', 'inside', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding M2M table for field players on 'Report'
        db.create_table('mapping_report_players', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm['mapping.report'], null=False)),
            ('player', models.ForeignKey(orm['namelist.player'], null=False))
        ))
        db.create_unique('mapping_report_players', ['report_id', 'player_id'])


    def backwards(self, orm):
        
        # Deleting field 'Report.inside'
        db.delete_column('mapping_report', 'inside')

        # Removing M2M table for field players on 'Report'
        db.delete_table('mapping_report_players')
