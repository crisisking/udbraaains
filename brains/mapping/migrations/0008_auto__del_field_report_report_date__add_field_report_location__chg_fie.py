...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Report.report_date'
        db.delete_column('mapping_report', 'report_date')

        # Adding field 'Report.location'
        db.add_column('mapping_report', 'location', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mapping.Location']), keep_default=False)

        # Changing field 'Report.barricade_level'
        db.alter_column('mapping_report', 'barricade_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'Report.report_date'
        db.add_column('mapping_report', 'report_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Deleting field 'Report.location'
        db.delete_column('mapping_report', 'location_id')

        # Changing field 'Report.barricade_level'
        db.alter_column('mapping_report', 'barricade_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
