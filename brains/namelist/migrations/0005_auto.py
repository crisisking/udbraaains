...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Player', fields ['group_name']
        db.create_index('namelist_player', ['group_name'])


    def backwards(self, orm):
        
        # Removing index on 'Player', fields ['group_name']
        db.delete_index('namelist_player', ['group_name'])
